...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        kb.append([InlineKeyboardButton(text='Support', url='https://t.me/staz_support'),
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                ...
                                url='https://t.me/starz_support',
                            ),
                            InlineKeyboardButton(
                                text=gs(chat.id, "updates_channel_link_btn"),
                                url="https://t.me/starz_updates",
                            ),
                            InlineKeyboardButton(
                                text=gs(chat.id, "src_btn"),
                                url="https://github.com/statzbots",
                            ),
                        ],
                        [
                            InlineKeyboardButton(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            ...
                            InlineKeyboardButton(
                                text=gs(chat.id, "src_btn"),
                                url="https://github.com/starzbots",
                            ),
                        ],
                        [
                            InlineKeyboardButton(
        ...
        if mod_match:
            ...
            help_buttons.append(
                [InlineKeyboardButton(text="Back", callback_data="help_back"),
                 InlineKeyboardButton(text='Support', url='https://t.me/starz_support')]
            )
            ...
            kb.append([InlineKeyboardButton(text='Support', url='https://t.me/starz_support'),
                       InlineKeyboardButton(text='Back', callback_data='start_back'),
                       InlineKeyboardButton(text="Try inline", switch_inline_query_current_chat="")])
            query.message.edit_text(
